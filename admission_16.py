...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 18 19:25:09 2020
...
for p in [0, 50]:
    URL = 'https://mathematicsgre.com/viewtopic.php?f=1&t=3518&start='f'{p}'
...
with open("GPA_final_16.txt", "w") as output:
...
with open("Accepted_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_perc_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_scores_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_percent_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_scores_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_percent_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_scores_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_percent_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_scores_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("major_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("origin_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("post_final_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("rejected_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("research_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gpa_scale_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("sex_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
    for val in sex_list:
        writer.writerow([val])           
...
with open("toefl_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("universities_16.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
