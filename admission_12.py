...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  1 18:35:53 2020
...
for p in [0, 50]:
    URL = 'https://mathematicsgre.com/viewtopic.php?f=1&t=685&start='f'{p}'
...
# unique user list with only usefull names
  
user_final =[]
    
for ind in index_usefull:
     user_final.append(unique_user_list[ind])
...
for i in range(len(scale_list)):
    if "math" in scale_list[i]:
        scale_list[i] = "4"
        
for i in range(len(scale_list)):
    if "Undergraduate" in scale_list[i]:
        scale_list[i] = "10"
...
domestic_list = ['domestic', 'dwm', 'american', 'us', 'dam']
international_list = ['international', 'canadian', 'russian']
...
for i in range(len(type_list)):
    ...
    'dwm' in type_list[i].lower() or 'dude' in type_list[i].lower():
        sex_list.append('0')
    else:
        sex_list.append('NA')
...
for i in range(len(gre_q_percent)):
    if gre_q_percent[i][0] in numbers:
        ...
        gre_q_percent[i] = gre_q_percent[i]
...
with open("GPA_final_12.txt", "w") as output:
...
with open("Accepted_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_perc_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_scores_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_percent_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_scores_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_percent_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_scores_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_percent_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_scores_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("major_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("origin_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("post_final_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("rejected_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("research_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gpa_scale_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("sex_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
    for val in sex_list:
        writer.writerow([val])           
...
with open("toefl_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("universities_12.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
