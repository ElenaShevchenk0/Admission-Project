...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 12:33:28 2020
...
for p in [0, 50, 100]:
    URL = 'https://mathematicsgre.com/viewtopic.php?f=1&t=3695&start='f'{p}'
...
for i in range(len(GPA_list)):
    ...
    if GPA_list[i][0] == '(':
        GPA_list[i] = GPA_list[i][1:len(GPA_list[i])]
    if GPA_list[i][0] == 'T':
        GPA_list[i] = GPA_list[i][31:len(GPA_list[i])]     
    if GPA_list[i][0] == 's':
        GPA_list[i] = GPA_list[i][4:len(GPA_list[i])]  
    if GPA_list[i][0] == 'C':
...
for i in range(len(gre_v_scores)):
    if '%' in  gre_v_scores[i]: 
        gre_v_scores[i] = dict_v_perc[gre_v_scores[i].replace("%","")]
...
with open("GPA_final_17.txt", "w") as output:
...
with open("Accepted_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_perc_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_scores_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_percent_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_scores_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_percent_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_scores_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_percent_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_scores_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("major_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("origin_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("post_final_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("rejected_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("research_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gpa_scale_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("sex_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
    for val in sex_list:
        writer.writerow([val])           
...
with open("toefl_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("universities_17.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
