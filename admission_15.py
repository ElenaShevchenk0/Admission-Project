...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 18 15:21:58 2020
...
for p in [0, 50]:
    URL = 'https://mathematicsgre.com/viewtopic.php?f=1&t=3297&start='f'{p}'
...
for i in range(len(GPA_list)):
    if GPA_list[i][0] == 'a':
        GPA_list[i] = GPA_list[i][6:len(GPA_list[i])]
    if GPA_list[i][0] == '~':
        GPA_list[i] = GPA_list[i][1:len(GPA_list[i])]
    if GPA_list[i][0] == 'M':
        GPA_list[i] = GPA_list[i][32:len(GPA_list[i])]
    if GPA_list[i][0] == 'G':
        GPA_list[i] = GPA_list[i][8:len(GPA_list[i])]
    if GPA_list[i][0] == 'C':
...
with open("GPA_final_15.txt", "w") as output:
...
with open("Accepted_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_perc_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_scores_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_percent_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_scores_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_percent_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_scores_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_percent_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_scores_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("major_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("origin_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("post_final_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("rejected_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("research_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gpa_scale_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("sex_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
    for val in sex_list:
        writer.writerow([val])           
...
with open("toefl_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("universities_15.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
