...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 16 18:49:13 2020
...
for p in [0, 50, 100]:
    URL = 'https://mathematicsgre.com/viewtopic.php?f=1&t=1003&start='f'{p}'
...
for i in range(len(GPA_list)):
    if GPA_list[i][0] == 'a':
        GPA_list[i] = GPA_list[i][11:len(GPA_list[i])]
    if GPA_list[i][0] == '~':
        GPA_list[i] = GPA_list[i][1:len(GPA_list[i])]
    if GPA_list[i][0] == 'M':
        GPA_list[i] = GPA_list[i][5:len(GPA_list[i])]
    if GPA_list[i][0] == 'G':
        GPA_list[i] = GPA_list[i][8:len(GPA_list[i])]
    if GPA_list[i][0] == 'C':
        GPA_list[i] = GPA_list[i][12:len(GPA_list[i])]
...
with open("GPA_final_13.txt", "w") as output:
...
with open("Accepted_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_perc_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_scores_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_percent_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_scores_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_percent_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_scores_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_percent_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_scores_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("major_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("origin_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("post_final_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("rejected_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("research_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gpa_scale_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("sex_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
    for val in sex_list:
        writer.writerow([val])           
...
with open("toefl_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("universities_13.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
