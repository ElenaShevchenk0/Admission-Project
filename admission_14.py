...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 17 22:15:02 2020
...
for p in [0, 50]:
    URL = 'https://mathematicsgre.com/viewtopic.php?f=1&t=1523&start='f'{p}'
...
with open("GPA_final_14.txt", "w") as output:
...
with open("Accepted_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_perc_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_scores_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_percent_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_scores_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_percent_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_scores_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_percent_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_scores_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("major_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("origin_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("post_final_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("rejected_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("research_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gpa_scale_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("sex_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
    for val in sex_list:
        writer.writerow([val])           
...
with open("toefl_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("universities_14.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
