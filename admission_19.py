...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 18:20:54 2020
...
for p in [0, 50, 100, 150]:
    URL = 'https://mathematicsgre.com/viewtopic.php?f=1&t=4555&start='f'{p}'
...
for i in range(len(GPA_list)):
    ...
    if 'well, ' in GPA_list[i]:
        GPA_list[i] = GPA_list[i].replace('well, ', '')
    if '~'  in GPA_list[i]:
        GPA_list[i] = GPA_list[i].replace('~' , '')
    if 'Major '  in GPA_list[i]:
        GPA_list[i] = GPA_list[i].replace('Major ' , '')  
    if 'major: '  in GPA_list[i]:
        GPA_list[i] = GPA_list[i].replace('major: ' , '')   
    if 'Less than '  in GPA_list[i]:
        GPA_list[i] = GPA_list[i].replace('Less than ' , '')       
...
international_list = ['international', 'canadian', 'russian', 'turkey', 'italy',
                      'african', 'chinese', 'british', 'european', 'turkish']
...
with open("GPA_final_19.txt", "w") as output:
...
with open("Accepted_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_perc_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_m_scores_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_percent_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_q_scores_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_percent_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_v_scores_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_percent_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gre_w_scores_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("major_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("origin_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("post_final_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("rejected_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("research_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("gpa_scale_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("sex_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
    for val in sex_list:
        writer.writerow([val])           
...
with open("toefl_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
...
with open("universities_19.txt", "w") as output:
    writer = csv.writer(output, lineterminator='\n')
